...
import earth.terrarium.worldofwonder.common.block.DandeLionSproutBlock;
import earth.terrarium.worldofwonder.common.block.DandelionBlock;
import earth.terrarium.worldofwonder.common.block.DandelionFluffBlock;
import earth.terrarium.worldofwonder.common.block.FlammableFenceBlock;
import earth.terrarium.worldofwonder.common.block.FlammableFenceGateBlock;
import earth.terrarium.worldofwonder.common.block.FlammableSlabBlock;
import earth.terrarium.worldofwonder.common.block.FlammableStairsBlock;
import earth.terrarium.worldofwonder.common.block.PottedSproutBlock;
import earth.terrarium.worldofwonder.common.block.WonderCeilingHangingSignBlock;
import earth.terrarium.worldofwonder.common.block.WonderFlammableBlock;
import earth.terrarium.worldofwonder.common.block.WonderSignBlock;
import earth.terrarium.worldofwonder.common.block.WonderWallHangingSignBlock;
import earth.terrarium.worldofwonder.common.block.WonderWallSignBlock;
import earth.terrarium.worldofwonder.common.block.WonderWoodBlock;
...
public class WonderBlocks {
    ...
    public static final RegistryObject<Block> STEM_SIGN = add("stem_sign", () -> new WonderSignBlock(BlockBehaviour.Properties.of(), WonderWoodTypes.STEM), new Item.Properties().stacksTo(16), (block, properties) -> new SignItem(properties, block, WonderBlocks.STEM_WALL_SIGN.get()));
    ...
    public static final RegistryObject<Block> STEM_WALL_SIGN = add("stem_wall_sign", () -> new WonderWallSignBlock(BlockBehaviour.Properties.of(), WonderWoodTypes.STEM));
    ...
    public static final RegistryObject<Block> STEM_HANGING_SIGN = add("stem_hanging_sign", () -> new WonderCeilingHangingSignBlock(BlockBehaviour.Properties.of(), WonderWoodTypes.STEM), new Item.Properties().stacksTo(16), (block, properties) -> new HangingSignItem(WonderBlocks.STEM_HANGING_SIGN.get(), WonderBlocks.STEM_HANGING_WALL_SIGN.get(), properties));
    public static final RegistryObject<Block> STEM_HANGING_WALL_SIGN = add("stem_hanging_wall_sign", () -> new WonderWallHangingSignBlock(BlockBehaviour.Properties.of(), WonderWoodTypes.STEM));
